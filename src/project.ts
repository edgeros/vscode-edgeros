...
<div class="row ">
<span class="tit">${localize(
    'template.projectName.text',
    'Project name'
  )}</span>
<span class="con inputTxt">
<input class="projectName" placeholder="${localize(
    'template.projectName.input.text',
    'discription'
  )}"   type="text" />
</span>
</div>
...
<div class="con newBtnWarp">
   ...
   <button class="newbtn" onClick="submitNew()">${localize(
     'template.new.text',
     'browse'
   )}</button></span>
</div>
