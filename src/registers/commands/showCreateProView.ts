 ...
 * @Last Modified time: 2021-06-01 17:51:55
 */
    ...
    if (currentPanel) {
      ...
      currentPanel.webview.html = await ejs.renderFile(path.join(context.extensionPath, 'view', webViewFileName, 'view.ejs'), {
        ...
        language: {
          ...
          "versionIdNotEmptyText": localize('contentNotEmpty.txt', "content cannot be empty"),
          "versionIdIncorrectFormatText": localize('versionIdIncorrectFormatText.txt', "Must be a pure number"),
        }
      });
